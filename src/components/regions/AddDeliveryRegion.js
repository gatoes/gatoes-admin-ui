...
import { addDriverGeofencing, addDriverGeofencingSuccess } from '../../actions/regions';
import Tooltip from '../common/Tooltip';

class AddDeliveryRegion extends Component {
  constructor(props){
    super(props);
    this.state = {
  ...
  submitMenuForm(values){
    ...
    .then((result) => {
      ...
      toast.success('Delivery Region added Successfully.');
      this.props.reset();
      this.props.updateRegion(result);
    }).catch(error => {
...
AddDeliveryRegion = reduxForm({
  form: 'AddDeliveryRegionValue',
...
const mapDispatchToProps = (dispatch) => {
  return {
    addDriverGeofencingSuccess: (payload) => {
      dispatch(addDriverGeofencingSuccess(payload));
    },
  };
}

export default connect(null, mapDispatchToProps)(AddDeliveryRegion);