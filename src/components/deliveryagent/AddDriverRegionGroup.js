...
import { addDeleveryRegionGroup } from '../../actions/deliveryagent';

class AddDriverRegionGroup extends Component {
  constructor(props) {
    super(props);
    this.state = {
      deliveryRegion: []
  ...
  componentDidMount(){
    getDeliveryRegionGroup().then((response) => {
      this.setState({
  ...
  render() {
    ...
    //console.log('aaaa', deliveryRegion);
    return (
...
AddDriverRegionGroup = reduxForm({
...
export default AddDriverRegionGroup;