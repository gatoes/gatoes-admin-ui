...
class OrderFilter extends Component {
	...
	onApply(e, val){
  	...
  	render() {
  		const { name, startDate, endDate, dateRangeString, shopListing, shopId, shopObj, regionListing, zoneId} = this.state;
  		let shopData = [];
	                ...
	                <div className="col-sm-3 col-lg-4 col-xl-3">
	              	...
	              	<div className="col-sm-3 align-self-center">
	                  	<div className="filter-result-block">
	                      	...
	                      	<a className="reset-btn" href="/dashboard/orderreporting">Reset</a>
	                  	</div>
	                </div>
