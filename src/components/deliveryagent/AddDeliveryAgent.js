...
import { addDeliveryAgent } from '../../actions/deliveryagent';
import { getBankList } from '../../actions/shops';
import {RIDER_WORKING_SHIFT, RIDER_TYPE} from '../../constants';

class AddDeliveryAgent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      regionListing : [],
      ...
      <div className="container ani-ui-block shop-manager">
        <div className="row menu-top-block">
          <div className="col-sm-12 tl-block align-self-center">
            <h4 className="heading">Add New Delivery Agent</h4>
          </div>
                ...
                <div className="add-left-block">
                  ...
                  <div className="row">
                    <div className="col-lg-12 col-md-12 order-lg-2">
                      <DeliveryAgentImage getAgentImage={this.getAgentImage} />
                    </div>
                  </div>
