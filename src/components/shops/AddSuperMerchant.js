...
import { addSuperMerchant, getShopListing } from '../../actions/shops';
import {toast} from 'react-toastify';
import validate from './ValidateSuperShop';

class AddSuperMerchant extends Component {
  constructor(props) {
    super(props);
    this.state = {
      shops : []
      ...
      <div className="container ani-ui-block shop-manager">
        <div className="row menu-top-block">
          <div className="col-sm-12 tl-block align-self-center">
            <h4 className="heading">Add Super Merchant</h4>
          </div>
...
AddSuperMerchant = reduxForm({
  form: 'AddSuperMerchantValue',
...
export default AddSuperMerchant;
