...
export default class MenuItemImage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      init: true,
  ...
  //       itemImageUrl: null
  //     });
  //     console.log('111',this.state.itemImageUrl);
  //     this.props.getItemImage(res.data[0].id);
  ...
  imageOnLoad(res) {
    ...
    if (res.success === true) {
        ...
        this.props.getItemImage(res.data.id);
    ...
    return (
      <div className="upload-right-block">
        <div className="upload-ui-block">
          <div className="up-img-block">
            <FilePond ref={ref => this.pond = ref}
              ...
              maxFiles={1}
              server={{
                  url:API_ROOT+"/common/uploadfile?image_type=ITEM_IMAGE",
                  process: {
        ...
        
        {
          ...
          <div className="imageshowpanel"><img src = {this.state.itemImageUrl} style={{width: 100+"%"}} /></div>
        }
